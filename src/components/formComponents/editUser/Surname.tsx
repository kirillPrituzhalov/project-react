...
export const Surname = React.memo(() => {
  const {
    control,
    resetField,
    watch,
  ...
  const handleClickClearSurname = () => {
    resetField('surname');
  };
  const handleMouseDownSurname = (
  ...
  return (
    <>
      <div className="edit-user__item edit-user__last-name">
        <label>Фамилия</label>
        <Controller
          control={control}
          name="surname"
                  ...
                  <InputAdornment position="end" sx={{ paddingRight: '6px' }}>
                    {watch('surname') && (
                      <IconButton
                        ...
                        onClick={handleClickClearSurname}
                        onMouseDown={handleMouseDownSurname}
                        edge="end"
