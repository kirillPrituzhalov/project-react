...
const Profile = () => {
  const faqList = useSelector((state: RootState) => state.profile.faqList);
        ...
        <div className="profile__data">
          <div className="profile__data-item">
            <ul>
              ...
              <li className="profile__item-bottom">Анастасия</li>
            </ul>
          </div>
          <div className="profile__data-item">
            <ul>
              <li className="profile__item-top">Фамилия</li>
              <li className="profile__item-bottom">Филатовна</li>
            </ul>
          </div>
          <div className="profile__data-item">
            <ul>
              <li className="profile__item-top">Телефон</li>
              <li className="profile__item-bottom">+7 908 555 35 35</li>
            </ul>
          </div>
          <div className="profile__data-item">
            <ul>
              <li className="profile__item-top">Электронная почта</li>
              <li className="profile__item-bottom">nastie203@mail.ru</li>
            </ul>
          </div>
        </div>
